...
const { Reservation, Business, User, Rating } = require('../models');
...
class ReservationController {
  ...
  async getUserReservations(req, res) {
    try {
      ...
      const reservations = await Reservation.findAndCountAll({
        ...
        include: [{
          model: Business,
          attributes: ['id', 'business_name', 'business_type', 'address', 'phone']
        }],
  ...
  async getReservation(req, res) {
    try {
      ...
      const reservation = await Reservation.findOne({
        ...
        include: [{
          model: Business,
          attributes: ['id', 'business_name', 'business_type', 'address', 'city', 'phone', 'working_hours']
        }, {
          model: Rating,
          where: { user_id: userId },
          required: false,
          attributes: ['stars', 'comment', 'created_at']
        }]
      });
  ...
  async updateReservation(req, res) {
    try {
      ...
      await reservation.update(filteredUpdates);
